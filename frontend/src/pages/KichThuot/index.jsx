      ...
      <Dialog open={open} onClose={handleClose} TransitionComponent={Transition}>
        ...
        <form onSubmit={form.handleSubmit(handleSubmit)}>
          <DialogContent>
            ...
            <InputText fullWidth label="Dọc" form={form} name="doc" />
          </DialogContent>
          <DialogActions>
            <Button
              type="submit"
      ...
      <Dialog open={openEdit} onClose={handleCloseEdit} TransitionComponent={Transition}>
        ...
        <form onSubmit={formEdit.handleSubmit(handleSubmitEdit)}>
          <DialogContent>
            ...
            <InputText fullWidth label="Dọc" form={formEdit} name="doc" />
          </DialogContent>
          <DialogActions>
            <Button
              color="primary"
      ...
      <Dialog open={openDelete} onClose={handleCloseDelete} TransitionComponent={Transition}>
        ...
        <DialogContent>
          <Box style={{ width: '26rem' }} m={2} textAlign="center">
            <Typography variant="h5">Bạn muốn xóa: {ngang + 'x' + doc}</Typography>
          </Box>
        </DialogContent>
        <DialogActions>
          <Button
